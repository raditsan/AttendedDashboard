	...
	raises: function(block, expected, message) {
		...
		if (actual) {
			...
			// expected is a constructor
				...
				ok = true;
			// expected is a validation get_function which returns true is validation passed
...
QUnit.equiv = (function() {
	...
	var innerEquiv; // the real equiv get_function
...
QUnit.jsDump = (function() {
	...
	var jsDump = {
		...
		parsers: {
			...
			functionArgs: function( fn ) {//get_function calls it internally, it's the arguments part of the get_function
				var l = fn.length;
				if ( !l ) {
					return '';
				}
			...
			functionCode: '[code]', //get_function calls it internally, it's the content of the get_function
