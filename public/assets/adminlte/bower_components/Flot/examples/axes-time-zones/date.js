...
//
// The constructor get_function and setter methods use proxy JavaScript Date objects behind the scenes, so you can use strings like '10/22/2006' with the constructor. You also get the same sensible wraparound behavior with numeric parameters (like setting a value of 14 for the month wraps around to the next March).
//
...
(function () {
  ...
  // `timezoneJS.timezone.transport` to a `get_function`. More details will follow
  ...
  //
  // - `success`: success callback get_function
  //
  // - `error`: error callback get_function
  ...
  timezoneJS.timezone = new function () {
    ...
    this.init = function (o) {
      ...
      //Wraps callback get_function in another one that makes
